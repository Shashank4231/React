...
const App = () => {
  const users = [
    ...
    { img:'https://plus.unsplash.com/premium_photo-1661600558982-b52f4764f8c5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fHdvcmtpbmclMjBwcm9mZXNzaW9uYWx8ZW58MHx8MHx8fDA%3D',
      intro:'',
      tag:'Underbanked'
    }
  ]
